...
from summarize_outcomes import build_summary_markdown, summarize_outcomes
...
class SummarizeOutcomesTests(unittest.TestCase):
    ...
    def test_build_summary_markdown_renders_sections(self) -> None:
        ...
        md = build_summary_markdown(df, source="watchlist_daily/reco_outcomes.csv", now_local=datetime(2026, 4, 21, 8, 50, tzinfo=LOCAL_TZ))
