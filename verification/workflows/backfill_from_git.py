...
from daily_theme_watchlist import CONFIG, add_indicators, build_market_scenario
from verification.reports.verify_recommendations import (
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default=str(VERIFICATION_OUTDIR / "backfill_reports"))
    parser.add_argument("--snapshot-csv", default=str(VERIFICATION_OUTDIR / "reco_snapshots.csv"))
